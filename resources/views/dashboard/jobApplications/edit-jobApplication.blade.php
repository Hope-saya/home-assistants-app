              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="about" value="{{ $jobPosting->about }}" name="about" placeholder="">
                  </div>
                </div>
                <div class="col-6">
                  <div class="form-group">
                ...
                <div class="col-6">
                  <div class="form-group">
                    <label for="availability">Availability</label>
                      <select class="form-control" id="availability" value="{{ $jobPosting->availability }}"name="availability">
                  ...
                  <div class="form-group">
                    <label for="skillset">Skillset</label>
                      <select class="form-control" id="skillset" value="{{ $jobPosting->skillset }}"name="skillset">
